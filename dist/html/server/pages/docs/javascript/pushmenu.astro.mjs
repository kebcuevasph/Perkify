...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      children: "The Pushmenu plugin is used to toggle the visibility of a sidebar menu. It allows users to collapse or expand the sidebar by clicking on a button or a link."
      ...
      children: ["Add ", createVNode(_components.code, {
        children: "data-lte-toggle=\"sidebar\""
      }), " to any button or link element to activate the plugin."]
...
Content.moduleId = "/workspaces/Perkify/src/html/components/javascript/pushmenu.mdx";
__astro_tag_component__(Content, 'astro:jsx');

const $$Pushmenu = createComponent(($$result, $$props, $$slots) => {
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content">
          <!--begin::Container-->
          <div class="container-fluid">
            ${renderComponent($$result, "Pushmenu", Content, {})}
          </div>
          <!--end::Container-->
        </div>
        <!--end::App Content-->
...
}, "/workspaces/Perkify/src/html/pages/docs/javascript/pushmenu.astro", void 0);

const $$file = "/workspaces/Perkify/src/html/pages/docs/javascript/pushmenu.astro";
const $$url = "/docs/javascript/pushmenu.html";
