...
const $$General = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en">\n  <!--begin::Head-->\n  <head>\n    ', "\n  ", '</head>\n  <!--end::Head-->\n  <!--begin::Body-->\n  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">\n    <!--begin::App Wrapper-->\n    <div class="app-wrapper">\n      ', "\n      ", `
      ...
      <!--end::App Main-->
      `, "\n    </div>\n    <!--end::App Wrapper-->\n    <!--begin::Script-->\n    ", "\n    <!--end::Script-->\n  </body><!--end::Body--></html>"])), renderComponent($$result, "Head", $$Head, { "title": title, "path": path }), renderHead(), renderComponent($$result, "Topbar", $$Topbar, { "path": path }), renderComponent($$result, "Sidenav", $$Sidenav, { "path": path, "mainPage": mainPage, "page": page }), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "Scripts", $$Scripts, { "path": path }));
}, "/workspaces/Perkify/src/html/pages/forms/general.astro", void 0);

const $$file = "/workspaces/Perkify/src/html/pages/forms/general.astro";
