...
const $$LayoutRtl = createComponent(($$result, $$props, $$slots) => {
  ...
  const isRtl = true;
  return renderTemplate`<html lang="en" dir="rtl">
  <!--begin::Head-->
  <head>
    ${renderComponent($$result, "Head", $$Head, { "title": title, "path": path, "isRtl": isRtl })}
  ${renderHead()}</head>
  <!--end::Head-->
  <!--begin::Body-->
...
}, "/workspaces/Perkify/src/html/pages/layout/layout-rtl.astro", void 0);

const $$file = "/workspaces/Perkify/src/html/pages/layout/layout-rtl.astro";
