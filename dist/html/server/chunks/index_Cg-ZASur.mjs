import { e as createComponent, m as maybeRenderHead, r as renderTemplate, f as createAstro, h as addAttribute } from './astro/server_B8E05pQD.mjs';
import 'piccolore';
import 'clsx';

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const year = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`<!--begin::Footer-->${maybeRenderHead()}<footer class="app-footer">
  <!--begin::To the end-->
...
<!--end::Footer-->`;
}, "/workspaces/Perkify/src/html/components/dashboard/_footer.astro", void 0);
...
const $$Topbar = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!--begin::Header-->${maybeRenderHead()}<nav class="app-header navbar navbar-expand bg-body">
  <!--begin::Container-->
...
<!--end::Header-->`;
}, "/workspaces/Perkify/src/html/components/dashboard/_topbar.astro", void 0);
...
export { $$Topbar as $, $$Footer as a, convertPathToHtml as c };
